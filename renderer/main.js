process.env.HMR_PORT=64609;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
...
module.exports = {
  ...
  "scripts": {
    ...
    "pack": "npm run build && npm run pack:win && npm run pack:mac",
    "tslint": "tslint -c tslint.yml '**/*.ts?(x)' --fix",
    "jslint": "prettier -c '**/*.js' --write",
    "stylelint": "stylelint '**/*.scss' --fix",
    "lint": "npm run tslint && npm run jslint && npm run stylelint",
