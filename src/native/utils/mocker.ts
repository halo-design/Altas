...
export const writeCustomMockData = (data: object) => {
...
export const readCustomMockData = () => {
...
export const resetCustomMockData = () => {
  const defaultData = readDefaultMockData();
  log.info('重置并写入默认mock参数.');
  writeCustomMockData(defaultData);
};

export const removeCustomMockData = () => {
