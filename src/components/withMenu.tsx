...
const withMenu = (Component: any) => {
  class WithMenuComponent extends React.Component<any, any> {
    ...
    public createMenu (editor?: (tpl: any[]) => any[]) {
      const appTpl :any = {
        label: 'Altas',
        submenu: [{
          click: () => {
  ...
  return withRouter(WithMenuComponent);
}
