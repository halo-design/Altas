process.env.HMR_PORT=60348;process.env.HMR_HOSTNAME="localhost";// modules are defined as an array
...
ReactDOM.render(React.createElement(App_1.default, null), document.getElementById('MOUNT_NODE'));
